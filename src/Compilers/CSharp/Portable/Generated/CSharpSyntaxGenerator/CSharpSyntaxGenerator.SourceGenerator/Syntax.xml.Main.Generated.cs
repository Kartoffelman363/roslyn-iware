...
public partial class CSharpSyntaxRewriter : CSharpSyntaxVisitor<SyntaxNode?>
{
    ...
    public override SyntaxNode? VisitSqlStatement(SqlStatementSyntax node)
        => node.Update(VisitList(node.AttributeLists), VisitToken(node.SqlKeyword), VisitToken(node.SqlOpenBraceToken), VisitToken(node.SqlTextToken), VisitToken(node.SqlCloseBraceToken), (SqlDoClauseSyntax?)Visit(node.SqlDoClause));
...
#pragma warning restore RS0027
    ...
    public static SqlStatementSyntax SqlStatement(SyntaxList<AttributeListSyntax> attributeLists, SyntaxToken sqlKeyword, SyntaxToken sqlOpenBraceToken, SyntaxToken sqlTextToken, SyntaxToken sqlCloseBraceToken, SqlDoClauseSyntax? sqlDoClause)
    {
        ...
        return (SqlStatementSyntax)Syntax.InternalSyntax.SyntaxFactory.SqlStatement(attributeLists.Node.ToGreenList<Syntax.InternalSyntax.AttributeListSyntax>(), (Syntax.InternalSyntax.SyntaxToken)sqlKeyword.Node!, (Syntax.InternalSyntax.SyntaxToken)sqlOpenBraceToken.Node!, (Syntax.InternalSyntax.SyntaxToken)sqlTextToken.Node!, (Syntax.InternalSyntax.SyntaxToken)sqlCloseBraceToken.Node!, sqlDoClause == null ? null : (Syntax.InternalSyntax.SqlDoClauseSyntax)sqlDoClause.Green).CreateRed();
    }

    /// <summary>Creates a new SqlStatementSyntax instance.</summary>
    public static SqlStatementSyntax SqlStatement(SyntaxList<AttributeListSyntax> attributeLists, SyntaxToken sqlTextToken, SqlDoClauseSyntax? sqlDoClause)
        => SyntaxFactory.SqlStatement(attributeLists, SyntaxFactory.Token(SyntaxKind.SqlKeyword), SyntaxFactory.Token(SyntaxKind.OpenBraceToken), sqlTextToken, SyntaxFactory.Token(SyntaxKind.CloseBraceToken), sqlDoClause);
