...
public partial class CSharpSyntaxRewriter : CSharpSyntaxVisitor<SyntaxNode?>
{
    ...
    public override SyntaxNode? VisitSqlStatement(SqlStatementSyntax node)
        => node.Update(VisitList(node.AttributeLists), VisitToken(node.SqlKeyword), VisitToken(node.SqlOpenBraceToken), VisitToken(node.SqlTextToken), VisitToken(node.SqlCloseBraceToken), (ExpressionSyntax?)Visit(node.SqlDo));
...
#pragma warning restore RS0027
    ...
    public static SqlStatementSyntax SqlStatement(SyntaxList<AttributeListSyntax> attributeLists, SyntaxToken sqlKeyword, SyntaxToken sqlOpenBraceToken, SyntaxToken sqlTextToken, SyntaxToken sqlCloseBraceToken, ExpressionSyntax? sqlDo)
    {
        ...
        return (SqlStatementSyntax)Syntax.InternalSyntax.SyntaxFactory.SqlStatement(attributeLists.Node.ToGreenList<Syntax.InternalSyntax.AttributeListSyntax>(), (Syntax.InternalSyntax.SyntaxToken)sqlKeyword.Node!, (Syntax.InternalSyntax.SyntaxToken)sqlOpenBraceToken.Node!, (Syntax.InternalSyntax.SyntaxToken)sqlTextToken.Node!, (Syntax.InternalSyntax.SyntaxToken)sqlCloseBraceToken.Node!, sqlDo == null ? null : (Syntax.InternalSyntax.ExpressionSyntax)sqlDo.Green).CreateRed();
    }

    /// <summary>Creates a new SqlStatementSyntax instance.</summary>
    public static SqlStatementSyntax SqlStatement(SyntaxList<AttributeListSyntax> attributeLists, SyntaxToken sqlTextToken, ExpressionSyntax? sqlDo)
